"""Peewee migrations -- 004_20250618_160533.py.
...
def migrate(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    class ProcessingJob(pw.Model):
        ...
        paper = pw.ForeignKeyField(column_name='paper_id', field='doc_id', model=migrator.orm['paper'], null=True, on_delete='CASCADE')
        ...
        steps_completed = pw.TextField(default='[]')
        steps_failed = pw.TextField(default='[]')
