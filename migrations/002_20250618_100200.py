"""Peewee migrations -- 002_20250618_100200.py.
...
def migrate(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    class PageEmbedding(pw.Model):
        ...
        page_text = pw.TextField(null=True)
...
def rollback(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    migrator.remove_model('pageembedding')
